...
const QString BITCOIN_IPC_PREFIX("FC:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click FC: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start FC: click-to-pay handler");
    else
...
{
    // clicking on FC: URLs creates FileOpen events on the Mac:
